        ...
        <div class="overview">
                ...
                <div class="cards">
                    <div class="card card-1">
                        ...
                        <div class="card--data">
                            <div class="card--content">
                                <h5 style='color:white' class="card--title">Registered Students</h5>
                    ...
                    <div class="card card-1">
                        ...
                        <div class="card--data">
                            <div class="card--content">
                                <h5 style='color:white' class="card--title">Units</h5>
                                <h1><?php echo $unit;?></h1>
                            </div>
                    ...
                    <div class="card card-1">
                        ...
                        <div class="card--data">
                            <div class="card--content">
                                <h5 style='color:white' class="card--title">Registered Lectures</h5>
